          ...
          <div className="modal-content" style={{ maxWidth: 800 }}>
            <div className="modal-header" style={{ borderBottom: '1px solid var(--border-default)', paddingBottom: 16 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                ...
                <div>
                  <h2 className="modal-title" style={{ margin: 0 }}>Create Quotation</h2>
                  <p style={{ fontSize: 13, color: 'var(--text-muted)', margin: '4px 0 0 0' }}>Generate a new price quote for a client.</p>
                </div>
              </div>
              ...
              <div className="modal-body" style={{ padding: '24px', maxHeight: '70vh', overflowY: 'auto' }}>
                ...
                <div className="grid-2col">
                  <div className="form-group">
                    ...
                    <textarea className="form-input" rows="5" style={{ paddingLeft: 12 }} placeholder="Additional notes or terms..." value={form.notes} onChange={e => setForm({...form, notes: e.target.value})} />
                  </div>
